    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [os.path.join(get_package_share_directory('kinova_j2s7s300_moveit2_config'),
        ...
        Node(package='ros_ign_bridge',
             ...
             output='screen',
             arguments=['/world/default/model/j2s7s300/joint_state@sensor_msgs/msg/JointState[ignition.msgs.Model',
                        '--ros-args', '--log-level', log_level],
             parameters=[{'use_sim_time': use_sim_time}],
             remappings=[('/world/default/model/j2s7s300/joint_state', '/joint_states')]),
